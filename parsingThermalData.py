...
def compression_1(f, headers):
    (timestamp, x_res, y_res) = headers
    #print(timestamp)
    #print(x_res)
    #print(y_res)
...
def decompile(file_path):
    with gzip.open(file_path, "rb") as f:
        ...
        headers = (timestamp, x_res, y_res)

        if compression == 0:
            return compression_0(f, headers)
        elif compression == 1:
            return compression_1(f, headers)
