    ...
    def load_from(cls, filename):
        with open(filename) as stream:
            ...
            return cls(
                ...
                thermal_compose_file=thermal.get("compose_file", "/etc/cacophony/thermal-compose.yml"),
                audio_compose_file=audio.get("compose_file", "/etc/cacophony/audio-compose.yml"),
