...
class TestTagCalculations:
    ...
    def test_one_track_poor_clarity_gives_unidentified(self):
        ...
        assert (
            poorRatty[MESSAGE] == "Confusion between two classes (similar confidence)"
        )
    ...
    def test_not_first_tracks_overlap(self):
        ...
        ratty1["start_s"] = 1
        ratty1["end_s"] = 8
        ratty1[CONFIDENCE] = 0.9
        ratty2["start_s"] = 5
        ratty2["end_s"] = 8
        ratty2[CONFIDENCE] = 0.6
        ratty3["start_s"] = 7
        ratty3["end_s"] = 11
        ratty2[CONFIDENCE] = 0.7
        assert self.get_tags([ratty1, ratty2])[MULTIPLE] == {
            "event": MULTIPLE,
            CONFIDENCE: 0.7,
        }
...
def false_positive_result():
    return {FALSE_POSITIVE: {"event": "false positive", CONFIDENCE: DEFAULT_CONFIDENCE}}
